...
import photo2 from "../images/aiimage4.png";
    ...
    <div className="Appp">
      ...
      {/* <header >
        <div className="nav-bar">
          <div className="logo-container">
            <img src={photo1} alt="FutureInvo Logo" className="logo" />
          </div>
      ...
      <section className="main-content-999">
        <div className="header-content-999">
          ...
          <p className="tagline-999">
            Our Mobile Applications help businesses automate processes, enhance
      ...
      <section className="container-999">
        ...
        <div className="benefits-999">
          <h2>Benefits With Our Mobile Applications</h2>
          <ul>
            ...
            <li className="benefit-item teal-999">
              ⚙️ Mobile  Experiences — Seamless apps for effortless user experiences.
            </li>
            <li className="benefit-item orange-999">
              🔮 Better Results — Analyze user behaviour & interactions to create smarter.
              data.
            </li>
            <li className="benefit-item teal-999">
              🔐 Secure & Reliable — Proactive monitoring to ensure secure.
            </li>
            <li className="benefit-item orange-999">
              🚀 Mobile Apps — Let mobile technology handle the routine.
            </li>
          </ul>
        </div>
      </section>
      ...
      <div className="services-999">
        ...
        <p className="subheading-999">
          Your trusted partner for cutting-edge Mobile Applications.
        </p>

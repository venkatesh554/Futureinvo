  ...
  return (
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">
            Home › Business Tools Development › Custom ERP Modules
          </p>
          <h1>
            "Custom ERP Modules"
          </h1>
          <p className="tagline-999">
            Our Custom ERP Modules help businesses automate processes, enhance
      ...
      <section className="home-content-999">
        ...
        <h1>Custom ERP Modules</h1>
        <img src={aiPhoto8_1} alt="AI Illustration" className="right-image-999" />
        <p>
          Enterprise Resource Planning (ERP) systems are the backbone of modern businesses, but not every company finds standard ERP solutions sufficient to address its unique needs. At Futureinvo Solutions Pvt. Ltd., we specialize in building custom ERP modules that bring flexibility, scalability, and precision to business operations.
        </p>
        <p>
         Our tailored ERP modules are designed to align with the exact demands of each organization—whether it’s finance, HR, supply chain, sales, inventory, or compliance.
        </p>
        <p>Instead of forcing businesses to change their workflow to fit a rigid system, Futureinvo ERP modules are crafted to adapt to your processes. This ensures smooth integration, better adoption by employees, and higher returns on investment.</p>
      </section>
      ...
      <section className="container-999">
        ...
        <div className="benefits-999">
          <h2>Benefits With Our Custom ERP Modules</h2>
          ...
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Scalability</h3>
              <p>As your business expands, ERP modules can be extended.</p>
            </div>
          </div>
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Cross Department</h3>
              <p>Integrated tools for finance, HR, sales, inventory.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Data-Driven Insights</h3>
              <p>Advanced reporting and analytics that transform.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="why-choose-us-999">
        ...
        <p className="subheading-999">
          Your trusted partner for cutting-edge Custom ERP Modules.
        </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
                <summary>How are custom ERP modules different from standard ERP systems?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Standard ERP is built with common features, while custom ERP is designed to fit your processes, ensuring higher adoption and ROI.</div>
            </details>
         </div>  

          <div className="faq-item2-999">
            <details>
                <summary>Can new modules be added later?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">  Yes. Custom ERP modules are scalable, allowing businesses to expand functionality as they grow.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Will ERP disrupt my current operations?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999"> No. We design modules to fit into existing workflows with minimal disruption.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Does ERP support automation and AI?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Absolutely. We integrate automation for repetitive tasks and AI for predictive analytics & decision-making.</div>
            </details>
         </div>

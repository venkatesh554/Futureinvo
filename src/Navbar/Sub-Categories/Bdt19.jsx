  ...
  return (
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">
            Home › Business Tools Development › Recruitment & Onboarding Tools
          </p>
          <h1>
            "Recruitment & Onboarding Tools"
          </h1>
          <p className="tagline-999">
            Our Recruitment & Onboarding Tools help businesses automate processes, enhance
      ...
      <section className="home-content-999">
        ...
        <h1>Recruitment & Onboarding Tools</h1>
        <img src={aiPhoto8_1} alt="AI Illustration" className="right-image-999" />
        <p>
          Recruiting the right talent and onboarding them effectively is critical for any organization's success. At Future Invo Solutions, we build easy-to-use Recruitment & Onboarding Tools that simplify hiring, reduce costs, and speed up the entire talent acquisition process.
        </p>
        <p>Our tools automate job postings, candidate sourcing, resume parsing, and applicant tracking while ensuring compliance and transparency. With onboarding modules, new hires are welcomed seamlessly with digital paperwork, training modules, and orientation programs, ensuring faster integration into the workforce.</p>
        <p>Whether it's managing multiple job openings simultaneously or streamlining background verification, our Recruitment & Onboarding Tools help HR teams and managers optimize hiring processes, improve candidate experiences, and ensure faster deployment of talent.</p>
      </section>
      ...
      <section className="container-999">
        ...
        <div className="benefits-999">
          <h2>Benefits With Our Recruitment & Onboarding Tools</h2>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Automated Hiring</h3>
              <p>Streamline job postings, candidate sourcing.</p>
            </div>
          </div>
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Onboarding Efficiency</h3>
              <p>Digital paperwork, training modules.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Compliance & Transparency</h3>
              <p>Ensure compliance and transparency.</p>
            </div>
          </div>
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Faster Integration</h3>
              <p>Orientation programs, faster deployment.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Cost Reduction</h3>
              <p>Reduce costs, improve candidate experiences.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="why-choose-us-999">
        ...
        <p className="subheading-999">
          Your trusted partner for cutting-edge Recruitment & Onboarding Tools.
        </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
                <summary>How do your Recruitment & Onboarding tools improve the hiring process?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">By automating postings, parsing resumes, shortlisting, and onboarding, the entire hiring cycle becomes faster and more efficient.</div>
            </details>
         </div>  

          <div className="faq-item2-999">
            <details>
                <summary>Can your system handle bulk hiring?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. Our tools are scalable and can manage large volumes of applications and job openings simultaneously.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Does it integrate with HRMS and Payroll systems?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. It can integrate seamlessly with HR, payroll, and other enterprise systems.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary> How does onboarding work digitally?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">New hires complete paperwork, training, and orientation online, reducing delays and improving efficiency.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Is the platform customizable?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Absolutely. We tailor solutions according to your company's hiring and onboarding workflows.</div>
            </details>
        </div>
      </div>

...
import aiPhoto8_1 from '../images/aiimage1.2.png';
    ...
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">Home › IT Consulting › Enterprise Architecture</p>
      ...
      <div className="why-choose-us-999">
              ...
              <p className="subheading-999">
                Your trusted partner for cutting-edge Enterprise Architecture.
              </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
            <summary>How can Enterprise Architecture strategies Befenit My Business? <FontAwesomeIcon icon={faAnglesRight}/></summary>
            <div className="faq-answer2-999">Enterprise Architecture solutions streamline operations, enhance customer engaement, and drive business growth. </div>
          </details>
        </div>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Do You Offer Remote or On-Site Enterprise Architecture Strategies? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>What Do Enterprise Architecture Solutions Involve? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Can Future Invo Enterprise Architecture Assist With Cybersecurity Consulting? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>What Industries Does future invo Enterprise Architecture specialize? <FontAwesomeIcon icon={faAnglesRight}/></summary>

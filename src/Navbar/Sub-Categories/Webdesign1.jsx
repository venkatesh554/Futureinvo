...
import aiPhoto8_1 from '../images/aiimage3.1.png';
  ...
  return (
    <div className="Appp">
      ...
      <div className="home-content-999">
        ...
        <p>
          At Future Invo Solution Pvt. Ltd., we help businesses harness the full potential of UI/UX design to thrive in today's digital-first world. Our designs go beyond aesthetics—they transform how organizations engage with users, communicate their brand, and drive meaningful business growth
        </p>
        <p>
        ...
        <section className="container-999">
          ...
          <div className="benefits-999">
            <h2>Benefits With Our UI/UX Design</h2>
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                <h3>User Engagement</h3>
                <p>Attractive, intuitive designs keep users interested.</p>
              </div>
            </div>
            <div className="benefit-item teal-999">
              <div style={{ textAlign: 'right' }}>
                <h3>High Rates</h3>
                <p>Streamlined user flows make it easier for visitors.</p>
              </div>
            </div>
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                <h3>Brand Identity</h3>
                <p>User behaviour to drive smarter digital strategies.</p>
              </div>
            </div>
            <div className="benefit-item teal-999">
              <div style={{ textAlign: 'right' }}>
                <h3>Bounce Rates</h3>
                <p>Ensure secure and reliable web operations.</p>
              </div>
            </div>
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                <h3>LongTerm Customer</h3>
                <p>Positive user experiences build trust & repeat.</p>
              </div>
            </div>
          </div>
     ...
     <div className="services-999">
      ...
      <div className="why-choose-us-999">
              ...
              <p className="subheading-999">
                Your trusted partner for cutting-edge UI/UX Design.
              </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Do you provide UI/UX design services remotely, on-site, or both? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>What do UI/UX design solutions involve? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Can Future Invo assist with usability & accessibility in UI/UX design? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Which industries does Future Invo specialize in UI/UX design? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>What Industries Does future invo specialize in for UI/UX services? <FontAwesomeIcon icon={faAnglesRight}/></summary>

...
import aiPhoto8_1 from '../images/aiimage3.2.png';
    ...
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">Home › Web Design › Responsive Design</p>
          <h1>"Responsive Design"</h1>
          <p className="tagline-999">Our Responsive Design help businesses automate processes, enhance decision-making, and unlock new growth opportunities through intelligent innovation.</p>
        </div>
      </header>
      ...
      <div className="home-content-999">
        ...
        <section className="container-999">
          ...
          <div className="benefits-999">
            <h2>Benefits With Our Responsive Design</h2>
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                <h3>Device Experience</h3>
                <p>Works flawlessly across desktops, tablets.</p>
              </div>
            </div>
            <div className="benefit-item teal-999">
              <div style={{ textAlign: 'right' }}>
                <h3>SEO Performance</h3>
                <p>Google favours mobile-friendly websites, boosts rankings.</p>
              </div>
            </div>
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
            ...
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                <h3>Future Proof</h3>
                <p>Flexibile designs adapt to new devices & screen sizes.</p>
              </div>
            </div>
          </div>
      ...
      <div className="why-choose-us-999">
              ...
              <p className="subheading-999">
                Your trusted partner for cutting-edge Responsive Design.
              </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Do you provide responsive design services remotely, on-site, or both? <FontAwesomeIcon icon={faAnglesRight}/></summary>
            <div className="faq-answer2-999">We provide responsive design services both remotely & on-site,based on client needs & project requirements.</div>
          </details>
        </div>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>What do responsive design solutions involve? <FontAwesomeIcon icon={faAnglesRight}/></summary>
            <div className="faq-answer2-999">"We Offer both remote and on-site responsive design services tailored to your business needs".</div>
          </details>
        </div>

        <div className="faq-item2-999">
          <details>
            <summary>Can Future Invo assist with usability & accessibility in responsive design <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>Which industries does Future Invo specialize in responsive design? <FontAwesomeIcon icon={faAnglesRight}/></summary>
        ...
        <div className="faq-item2-999">
          <details>
            <summary>What Industries Does future invo specialize in for responsive design? <FontAwesomeIcon icon={faAnglesRight}/></summary>

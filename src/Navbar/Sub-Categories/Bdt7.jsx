  ...
  return (
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">
            Home › Business Tools Development › Elearning Platforms (LMS)
          </p>
          <h1>
            "Elearning Platforms (LMS)"
          </h1>
          <p className="tagline-999">
            Our Elearning Platforms (LMS) help businesses automate processes, enhance
      ...
      <section className="home-content-999">
        ...
        <h1>Elearning Platforms (LMS)</h1>
        <img src={aiPhoto8_1} alt="AI Illustration" className="right-image-999" />
        <p>
          ELearning management systems (LMS) have transformed the way organizations train employees, students, clients, and share knowledge. At FutureInvo Solutions Pvt. Ltd., we specialize in building customized, feature-rich, and user-friendly LMS platforms that enhance the e-learning experience for businesses, educational institutions, and training organizations.
        </p>
        <p>
           Our LMS solutions combine robust functionality with seamless usability, empowering organizations to efficiently create, manage, and deliver learning content.
        </p>
        <p>FutureInvo's LMS platforms are scalable, flexible, and tailored to meet the diverse needs of organizations across industries. With cutting-edge tools, you can deliver immersive, interactive, and data-driven learning experiences, ensuring that both learners and administrators have a seamless experience.</p>
      </section>
      ...
      <section className="container-999">
       <form className="form-group-999" onSubmit={handleSubmit}>
        ...
        <div className="benefits-999">
          <h2>Benefits With Our Elearning Platforms (LMS)</h2>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Learning Paths</h3>
              <p>Personalized learning experiences ensuring paths.</p>
            </div>
          </div>
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Engaging Content</h3>
              <p>Gamification, multimedia tools and AI-powered systems.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>AI-Powered Assessments</h3>
              <p>Automated personalized assessments, feedback.</p>
            </div>
          </div>
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Data-Driven Insights</h3>
              <p>Track learner progress, compare results.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
      ...
      <div className="why-choose-us-999">
        ...
        <p className="subheading-999">
          Your trusted partner for cutting-edge Elearning Platforms (LMS).
        </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
                <summary>Can the LMS be customized for different industries?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. We offer LMS solutions equipped with advanced and customized features including learning modules, course structures, user roles, and assessments.</div>
            </details>
         </div>  

          <div className="faq-item2-999">
            <details>
                <summary>Does the platform support mobile learning?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Absolutely. Our systems ensure access on mobile devices, tablets, and desktops, ensuring flexibility.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>How can I track learner progress?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Our platforms provide detailed analytics dashboards showing completion rates, assessment scores, engagement metrics, and more.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Can the LMS integrate with other systems?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. Integrations with HRM, ERP, payment gateways, and collaboration tools ensure seamless operations.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Is content secure and GDPR-compliant?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. Security is built into the system with data encryption, compliance standards, and GDPR adherence to safeguard all data.</div>
            </details>
        </div>
      </div>

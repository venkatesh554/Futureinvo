  ...
  return (
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">
            Home › Business Tools Development › Sales Automation & Lead Tracking
          </p>
          <h1>
            "Sales Automation & Lead Tracking"
          </h1>
          <p className="tagline-999">
            Our Sales Automation & Lead Tracking help businesses automate processes, enhance
      ...
      <section className="home-content-999">
        ...
        <h1>Sales Automation & Lead Tracking</h1>
        <img src={aiPhoto8_1} alt="AI Illustration" className="right-image-999" />
        <p>
          In today's highly competitive business world, sales teams need more than just hard work - they need smart systems that boost efficiency. At Futureinvo Solutions Pvt. Ltd., we build Sales Automation & Lead Tracking tools that streamline lead capturing, automate routine sales tasks, and empower teams to focus on nurturing leads and closing deals faster.
        </p>
        <p>
           We help businesses unlock new opportunities by turning raw leads into meaningful customer relationships while saving time, reducing costs, and increasing sales efficiency.</p>
           <p>Our tools automate lead pipelines, prospect management, and sales reporting to enhance ROI. With intelligent lead scoring, real-time tracking, and personalized follow-ups, your sales teams get actionable insights to prioritize efforts where they matter most.</p>
      </section>
...
<form className="form-group-999" onSubmit={handleSubmit}>
        ...
        <div className="benefits-999">
          <h2>Benefits With Our Sales Automation & Lead Tracking</h2>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Lead Capture</h3>
              <p>Score leads based on purchase intent.</p>
            </div>
          </div>
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Lead Scoring</h3>
              <p>Monitor every stage of the sales pipeline.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
          ...
          <div className="benefit-item teal-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Follow-ups</h3>
              <p>Set automated SMS, email, and chatbot prompts.</p>
            </div>
          </div>
          <div className="benefit-item orange-999">
            <div style={{ textAlign: 'right' }}>
              <h3>Improved Sales</h3>
              <p>Automating repetitive tasks so teams can focus.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <div className="services-999">
      ...
      <div className="why-choose-us-999">
        ...
        <p className="subheading-999">
          Your trusted partner for cutting-edge Sales Automation & Lead Tracking.
        </p>
      ...
      <div className="faq-container-999">
        ...
        <div className="faq-item2-999">
          <details>
                <summary>How does sales automation improve my team's performance?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">It removes repetitive manual tasks like data entry & follow-ups, enabling your team to focus on engaging leads and closing deals faster.</div>
            </details>
         </div>  

          <div className="faq-item2-999">
            <details>
                <summary> Can this system integrate with my current CRM?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. Our solutions seamlessly integrate with CRMs, ERPs, email, and marketing platforms.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>How does lead tracking help in decision-making?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Provides insights into the visibility of each prospect's journey, helping managers identify bottlenecks and optimize sales strategies.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Is AI included in your sales automation solution?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. AI-powered tools such as predictive lead scoring, smart scheduling, and conversion probability analysis are included.</div>
            </details>
         </div>

          <div className="faq-item2-999">
            <details>
                <summary>Can small businesses also benefit from sales automation?<FontAwesomeIcon icon={faAnglesRight} /></summary>
                <div className="faq-answer2-999">Yes. Our solutions are scalable for startups, SMEs, and enterprises alike.</div>
            </details>
        </div>
      </div>

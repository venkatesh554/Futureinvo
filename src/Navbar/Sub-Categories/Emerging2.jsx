...
import aiPhoto8_1 from '../images/aiphoto6-2.jpg';
    ...
    <div className="Appp">
      ...
      <header className="main-content-999">
        <div className="header-content-999">
          <p className="breadcrumbs-999">Home › Emerging Tech › IoT Development</p>
          <h1>“IoT Development”</h1>
          <p className="tagline-999">Our IoT Development helps businesses automate processes, enhance decision-making, and unlock new growth opportunities through intelligent innovation.</p>
        </div>
      </header>
      ...
      <div className="home-content-999">
        ...
        <p>
          The Internet of Things (IoT) is transforming the way businesses and consumers interact with the physical world. At Future Invo Solution Pvt. Ltd., we design and deploy IoT solutions that connect smart devices, sensors, and machines to create intelligent ecosystems for homes, industries, and enterprises. IoT, with our advanced connectivity and real-time data analytics, helps businesses streamline automation and derive actionable insights that drive productivity and innovation.
        </p>
        <p>
          Our Industrial IoT (IIoT) services specialize in manufacturing, logistics, and energy companies. These solutions offer advanced real-time monitoring and remote control of equipment and processes.
        </p>
      </div>
          ...
          <div className="benefits-999">
            ...
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                ...
                <p>Gain data-driven insights that guide strategic decisions.</p>
              </div>
            </div>
            ...
            <div className="benefit-item orange-999">
              <div style={{ textAlign: 'right' }}>
                ...
                <p>Identify inefficiencies and cut down.</p>
              </div>
            </div>
          </div>
      ...
      <div className="chatbots-999">
        <h1>Our Expertise in IoT Development</h1>
